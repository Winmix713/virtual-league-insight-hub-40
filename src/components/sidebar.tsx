...
import { 
  ...
  Layers, BarChart, Shield, Settings, ChevronRight,
  ChevronLeft
} from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        >
          {isOpen ? (
            <ChevronLeft className="w-5 h-5 animate-in" />
          ) : (
            <ChevronRight className="w-5 h-5 animate-in" />
          )}
        </button>
        ...
        <div className="px-4 mb-6">
          <a href="/" className="flex items-center gap-2 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] -mt-0.5 text-blue-500/90 font-medium tracking-wider">
                TIPSTER
              </span>
            </div>
          </a>
        ...
        <nav className="flex-1 px-3 py-2 space-y-1.5 overflow-y-auto">
          ...
          <NavItem
            ...
            endIcon={<ChevronRight size={16} className="text-gray-500 transition-transform duration-300 group-hover:translate-x-1" />}
          />
        ...
        <div className="mt-auto mx-3 mb-4">
          <div className="relative overflow-hidden rounded-lg border border-white/10 bg-gradient-to-br from-blue-900/20 to-purple-900/20 backdrop-blur-md p-4 group hover:border-blue-500/20 transition-all duration-300">
            ...
            <div className="relative z-10">
              ...
              <h4 className="font-medium text-sm mt-2 text-white">
                Upgrade to Pro Plan
              </h4>
